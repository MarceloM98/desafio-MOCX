...
export function DateInput({date, onChange}){
  ...
  return(
    <Container>
      <FiCalendar size={20}/>
      <input max='2023-01-01' min='1900-01-01' onChange={handleDateChange} placeholder='Data de nascimento' type={inputType}  onBlur={handleInputTypeChange} onFocus={handleInputTypeChange} value={formattedDate}
      />
